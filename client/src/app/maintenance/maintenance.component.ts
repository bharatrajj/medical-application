...
export class MaintenanceComponent implements OnInit {
  ...
  getMaintenance() {
    ...
    this.httpService.getMaintenance().subscribe((data: any) => {  // subscribe it used to handle the observable method response
...
// this method is reponsible got editing the completion date along with the status of the Maintenance of it
  edit(val: any) {
    ...
    this.itemForm.patchValue({                           // updating the formGroup using patchValue method
